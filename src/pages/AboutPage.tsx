...
export function AboutPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 pb-24 pt-10">
      ...
      />
      <h1 className="text-3xl font-bold text-slate-950 dark:text-slate-50">About</h1>
      <div className="mt-6 max-w-[65ch] space-y-5 text-slate-700 dark:text-slate-300">
        <p>
        ...
        <p>
          ...
          <code className="rounded bg-slate-200 px-1.5 py-0.5 text-sm text-gold-ink dark:bg-slate-800 dark:text-gold">
            npm run verify
          </code>{' '}
        ...
        <p>
          ...
          , or the{' '}
          <Link className="text-gold-ink hover:underline dark:text-gold" to={routes.home}>
            notes
          </Link>
          .
        </p>
